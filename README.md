...
I design clean databases, analyze messy datasets, automate workflows, and build dashboards that turn raw data into actionable insights. My work emphasizes **data integrity, logic, and analysis**, not surface-level visuals.
...
### 🚨 EdTech & IT Job Scams Analysis
- Collected real-world scam data from **LinkedIn and Reddit**  
- Cleaned and structured unorganized social media data into an analysis-ready dataset  
- Identified scam patterns, platforms, target groups, and red flags  
...
👉 Demonstrates **end-to-end analysis**: data collection → cleaning → insights → reporting
